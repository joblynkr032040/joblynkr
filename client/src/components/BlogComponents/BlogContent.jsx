...
//       <Typography
//         variant="h4"
//         className="font-bold text-center mb-8 leading-tight text-[#0C0520]"
//       >
//         {blog.title}
//       </Typography>
...
//             case "paragraph":
//               return (
//                 <Typography key={idx} variant="body1" className="text-lg">
//                   {block.text}
//                 </Typography>
//               );
//             case "heading":
//               return (
//                 <Typography key={idx} variant="h5" className="font-semibold text-[#0C0520]">
//                   {block.text}
//                 </Typography>
//               );
//             case "quote":
...
//                 <blockquote
//                   key={idx}
//                   className="italic border-l-4 border-gray-300 pl-4 text-gray-600"
//                 >
//                   {block.text}
//                 </blockquote>
//               );
...
//                 <pre
//                   key={idx}
//                   className="bg-gray-100 text-sm p-2 rounded-md overflow-x-auto text-gray-800"
//                 >
