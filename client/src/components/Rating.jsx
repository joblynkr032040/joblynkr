...
const Rating = () => {
  return (
    <div className="w-full text-center flex flex-col items-center justify-center py-12 px-4">
      {/* Badge */}
      <div className="flex items-center gap-2 bg-white border border-blue-500 text-blue-600 rounded-full px-4 py-2 shadow-sm mb-6">
      ...
      {/* Heading */}
      <h2 className="text-3xl sm:text-5xl font-bold text-black/95">
        Their success says{" "}
